...
- **DataFlow v0.10.15**: `auto_migrate=True` (default) works in Docker/FastAPI via the synchronous DDL executor
...
- Use `auto_migrate=True` (default) - works in Docker/FastAPI via the synchronous DDL executor
