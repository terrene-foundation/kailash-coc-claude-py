...
description: "Testing policy recommending real infrastructure for Tier 2-3 tests. Use when asking 'mocking policy', 'real infrastructure preferred', 'real infrastructure', 'test policy', 'mock guidelines', or 'testing standards'."
---

# Gold Standard: Real Infrastructure Policy

Real infrastructure policy for integration and E2E tests. Use LocalRuntime and AsyncLocalRuntime with real services where practical.
...
### Real infrastructure recommended for Tiers 2-3
...
**Tier 3 (E2E Tests)**: Real infrastructure preferred - Use real services end-to-end
...
async def test_complete_pipeline():
    """E2E test with real infrastructure."""
