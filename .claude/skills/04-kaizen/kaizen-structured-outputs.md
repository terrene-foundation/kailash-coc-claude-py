...
- [Kaizen BaseAgent Architecture](docs/kaizen/guides/baseagent-architecture.md)
- [Signature Programming Guide](docs/kaizen/guides/signature-programming.md)
- [OpenAI Structured Outputs Documentation](https://platform.openai.com/docs/guides/structured-outputs)
- [Kaizen Configuration Guide](docs/kaizen/reference/configuration.md)
