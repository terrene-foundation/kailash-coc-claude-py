...
**Version: 0.12.1** | Built on [Kailash Core SDK](https://github.com/your-org/kailash_sdk) | `pip install kailash-dataflow`
...
DataFlow is one of three frameworks built on the [Kailash Core SDK](https://github.com/your-org/kailash_sdk), each addressing a different layer of application development:
