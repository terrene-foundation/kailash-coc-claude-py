...
**Version: 1.4.1** | Built on [Kailash Core SDK](https://github.com/your-org/kailash_sdk) | `pip install kailash-nexus`
...
Nexus is one of three frameworks built on the [Kailash Core SDK](https://github.com/your-org/kailash_sdk), each addressing a different layer of application development:
...
| **[Kaizen](https://github.com/your-org/kailash-kaizen)**     | AI agent framework with trust        | `pip install kailash-kaizen`   |
