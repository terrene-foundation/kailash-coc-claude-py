...
**Version: 1.2.1** | Built on [Kailash Core SDK](https://github.com/your-org/kailash_sdk) | `pip install kailash-kaizen`
...
Kaizen is one of three frameworks built on the [Kailash Core SDK](https://github.com/your-org/kailash_sdk), each addressing a different layer of application development:

| Framework                                                           | Purpose                              | Install                        |
| ------------------------------------------------------------------- | ------------------------------------ | ------------------------------ |
| **[DataFlow](https://github.com/your-org/kailash-dataflow)** | Workflow-native database operations  | `pip install kailash-dataflow` |
| **[Nexus](https://github.com/your-org/kailash-nexus)**       | Multi-channel platform (API/CLI/MCP) | `pip install kailash-nexus`    |
